...
<body onload="connect();" onunload="disconnect();">
	...
	<div class="panel input-area">
		<input id="usuario" type="text" placeholder="Nome" /> <input
			id="messageInput" type="text" placeholder="Digite a mensagem"
			onkeydown="if (event.keyCode == 13) enviaMensagem();" /> <input
			class="button" type="submit" value="Enviar"
